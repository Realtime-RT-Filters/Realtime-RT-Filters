...
// Several functions for ray tracing imported from VulkanRayTracingSample

VulkanExampleBase::ScratchBuffer VulkanExampleBase::createScratchBuffer(VkDeviceSize size)
{
...
void VulkanExampleBase::deleteScratchBuffer(ScratchBuffer& scratchBuffer)
{
...
void VulkanExampleBase::createAccelerationStructure(AccelerationStructure& accelerationStructure, VkAccelerationStructureTypeKHR type, VkAccelerationStructureBuildSizesInfoKHR buildSizeInfo)
{
	// Buffer and memory
	VkBufferCreateInfo bufferCreateInfo{};
	bufferCreateInfo.sType = VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO;
...
void VulkanExampleBase::deleteAccelerationStructure(AccelerationStructure& accelerationStructure)
{
...
uint64_t VulkanExampleBase::getBufferDeviceAddress(VkBuffer buffer)
{
...
void VulkanExampleBase::createStorageImage(VkFormat format, VkExtent3D extent)
{
...
void VulkanExampleBase::deleteStorageImage()
{
...
VkStridedDeviceAddressRegionKHR VulkanExampleBase::getSbtEntryStridedDeviceAddressRegion(VkBuffer buffer, uint32_t handleCount)
{
...
void VulkanExampleBase::createShaderBindingTable(ShaderBindingTable& shaderBindingTable, uint32_t handleCount)
{
